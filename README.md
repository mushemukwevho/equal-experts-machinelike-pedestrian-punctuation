...
1. What kind of data quality measures would you apply to your solution in production?
   <b style='color:red'>schema validations, in-depth logging, in-depth unit test, over 80% code coverage on tests, if possible use postgres instead of duckdb</b>
2. What would need to change for the solution scale to work with a 10TB dataset with 5GB new data arriving each day?
3. <b style='color:red'>Instead of batch processing, streaming this data through may reduce data size load. You may ingest this data in chucks into a stream and process it.</b>
4. Please tell us in your modified README about any assumptions you have made in your solution.
5. <b style='color:red'>1. The required output seem to indicate weeks are being numbered using epidemiological weeks numbering system. First week starts with Sunday and must contain the January 4th (or first Wednesday of the year). I'm yet to find out how I can replicate epi weeks logic directly into duckdb, it would need a stored procedure most probably. I have used python to do most of the heavy lifting.</b>
   <b style='color:red'>2. I assumed that voting would start in the begining of the year.</b>
   <b style='color:red'>3. I'm not satisfied with my tests, I need to add more depth to it.</b>

<b style='color:red'>Due to time contraints and work demands, this is my submission for this assessment.</b>
